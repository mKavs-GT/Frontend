...
const navigationItems: NavigationItem[] = [
  ...
  { id: "project-management", name: "Project Management", icon: Briefcase, href: "/projects" },
  { id: "time-tracker", name: "Time Tracker", icon: Clock, href: "/time" },
...
export function Sidebar({ className = "", onNavigate, activeItem: externalActiveItem, onLogout, adminAgent, isCollapsed: externalIsCollapsed, onToggleCollapse }: SidebarProps) {
