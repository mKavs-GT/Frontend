...
export default function ClientProjects({ onViewProject, onLogout, adminAgent }: ClientProjectsProps) {
  ...
  return (
    <div className="flex h-screen w-full bg-[#020617] text-white font-sans overflow-hidden">
      <Sidebar onLogout={onLogout} adminAgent={adminAgent} activeItem="dashboard" />
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden bg-zinc-950/20">
        ...
        <div className="flex-1 overflow-y-auto px-10 pt-8 pb-10 custom-scrollbar">
          ...
          {/* Welcome Banner */}
          <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[32px] p-10 relative overflow-hidden text-white flex items-center shadow-[0_20px_50px_rgba(37,99,235,0.2)] min-h-[240px] group">
      ...
      {/* RIGHT SIDEBAR */}
      <aside className="w-[380px] bg-zinc-950/80 backdrop-blur-3xl h-full shrink-0 flex flex-col pt-10 pb-6 border-l border-white/5 z-20 overflow-y-auto custom-scrollbar">
